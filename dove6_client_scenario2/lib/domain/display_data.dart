...
class DisplayData {
  ...
  // Falls back to English if translation is empty.
  String currentStationIn(DisplayLanguage lang) {
    switch (lang) {
      case DisplayLanguage.fr:
        return currentStationFr.isEmpty
            ? currentStation : currentStationFr;
      case DisplayLanguage.ar:
        return currentStationAr.isEmpty
            ? currentStation : currentStationAr;
      default:
  ...
  String nextStationIn(DisplayLanguage lang) {
    switch (lang) {
      case DisplayLanguage.fr:
        return nextStationFr.isEmpty
            ? nextStation : nextStationFr;
      case DisplayLanguage.ar:
        return nextStationAr.isEmpty
            ? nextStation : nextStationAr;
      default:
        return nextStation;
    }
  }
  ...
  String destinationIn(DisplayLanguage lang) {
    switch (lang) {
      case DisplayLanguage.fr:
        return destinationFr.isEmpty
            ? destination : destinationFr;
      case DisplayLanguage.ar:
        return destinationAr.isEmpty
  ...
  List<String> routeStationsIn(DisplayLanguage lang) {
    switch (lang) {
      case DisplayLanguage.fr:
        return routeStationsFr.isEmpty
            ? routeStations : routeStationsFr;
      case DisplayLanguage.ar:
        return routeStationsAr.isEmpty
            ? routeStations : routeStationsAr;
      default:
